...
INSERT INTO comments VALUES ( 1000, STR_TO_DATE('07-10-2020 09:20 AM', '%m-%d-%Y %h:%i %p'), 'bandalls', 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tempora similique ipsam reprehenderit reiciendis totam quasi delectus quo fugit vitae ipsa dicta minima quas sequi quidem, deserunt aliquam cumque provident accusamus?', 0, NULL);
  INSERT INTO comments VALUES ( 1006, STR_TO_DATE('07-10-2020 11:33 AM', '%m-%d-%Y %h:%i %p'), 'flamesbria', 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tempora similique ipsam reprehenderit reiciendis totam quasi delectus quo fugit vitae ipsa dicta minima quas sequi quidem, deserunt aliquam cumque provident accusamus?', 1, 1000);
    INSERT INTO comments VALUES ( 1007, STR_TO_DATE('07-10-2020 11:48 AM', '%m-%d-%Y %h:%i %p'), 'heroanhart', 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tempora similique ipsam reprehenderit reiciendis totam quasi delectus quo fugit vitae ipsa dicta minima quas sequi quidem, deserunt aliquam cumque provident accusamus?', 2, 1006);
  INSERT INTO comments VALUES ( 1001, STR_TO_DATE('07-10-2020 12:22 PM', '%m-%d-%Y %h:%i %p'), 'wattlexp', 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tempora similique ipsam reprehenderit reiciendis totam quasi delectus quo fugit vitae ipsa dicta minima quas sequi quidem, deserunt aliquam cumque provident accusamus?', 1, 1000);

INSERT INTO comments VALUES ( 1002, STR_TO_DATE('07-10-2020 10:20 AM', '%m-%d-%Y %h:%i %p'), 'sweetiele', 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tempora similique ipsam reprehenderit reiciendis totam quasi delectus quo fugit vitae ipsa dicta minima quas sequi quidem, deserunt aliquam cumque provident accusamus?', 0, NULL);
